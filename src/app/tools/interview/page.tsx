...
import { Brain, ChevronLeft, Sparkles, ChevronRight, RotateCcw, Star, Clock, AlertCircle, Lock, CreditCard } from "lucide-react";
        ...
        {noCredits ? (
          <div style={{ textAlign:"center",padding:"72px 24px" }}>
            ...
            <p style={{ fontSize:15,color:"var(--muted)",maxWidth:380,margin:"0 auto 8px",lineHeight:1.7 }}>
              You need <strong>1 tool credit</strong> to start an Interview Session. Buy a credit pack to continue.
            </p>
